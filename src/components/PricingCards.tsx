...
const plans: PricingPlan[] = [
  {
    ...
    description: 'Try SportBot AI risk-free',
    features: [
      '1 match analysis per day',
      '1 AI Desk chat message',
      'Soccer matches only',
      'Basic match signals',
      'Community support',
    ],
  ...
  },
  {
    ...
    description: 'Perfect for daily sports analysis',
    features: [
      '30 match analyses per day',
      '50 AI Desk messages per day',
      'All sports (Soccer, NBA, NFL, NHL...)',
      'Advanced AI-powered insights',
      'Pre-match form & streaks',
  ...
  },
  {
    ...
    features: [
      ...
      'Unlimited AI Desk chat',
      'All sports + eSports + MMA',
