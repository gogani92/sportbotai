 ...
 * 
 * Objašnjava korisnicima kako BetSense AI funkcioniše
  ...
  const steps = [
    {
      number: '01',
      title: 'Unesi Meč',
      description: 'Izaberi sport, ligu i timove. Dodaj kvote koje si pronašao kod kladionice.',
      icon: (
    ...
    },
    {
      number: '02',
      title: 'AI Analiza',
      description: 'Naš AI analizira dostupne podatke i generiše procenu verovatnoća ishoda.',
      icon: (
        <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      number: '03',
      title: 'Dobij Uvid',
      description: 'Pregledaj detaljnu analizu, procenu rizika i edukativne napomene.',
      icon: (
        <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <section className="section-container">
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
          Jednostavan proces u tri koraka za dobijanje AI analize sportskih događaja.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {steps.map((step, index) => (
          <div key={step.number} className="relative">
            {/* Linija koja povezuje korake (samo na desktop-u) */}
