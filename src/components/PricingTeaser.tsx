  ...
  const plans = [
    {
      ...
      features: ['3 analyses per day', 'Basic probabilities', 'All sports access'],
      cta: 'Get Started',
      href: '/analyzer',
      highlighted: false,
    },
    {
      ...
      features: ['30 analyses/day', 'Team Intelligence', 'My Teams & History', 'Audio briefings'],
      cta: 'Upgrade to Pro',
      href: '/pricing',
      highlighted: true,
    },
    {
      ...
      features: ['Unlimited analyses', 'Priority AI processing', 'Full history access', 'Share cards'],
      cta: 'Go Premium',
      href: '/pricing',
      highlighted: false,
    },
